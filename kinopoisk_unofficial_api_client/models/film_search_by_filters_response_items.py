...
class FilmSearchByFiltersResponseItems:
    ...
    Attributes:
        ...
        imdb_id (Union[None, Unset, str]):  Example: tt0050561.
        ...
        rating_imdb (Union[None, Unset, float]):  Example: 7.9.
        year (Union[None, Unset, float]):  Example: 2012.
        type (Union[Unset, FilmSearchByFiltersResponseItemsType]):  Example: FILM.
    ...
    rating_imdb: Union[None, Unset, float] = UNSET
    year: Union[None, Unset, float] = UNSET
    type: Union[Unset, FilmSearchByFiltersResponseItemsType] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        rating_imdb: Union[None, Unset, float]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_rating_imdb(data: object) -> Union[None, Unset, float]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        type: Union[Unset, FilmSearchByFiltersResponseItemsType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = FilmSearchByFiltersResponseItemsType(_type)
