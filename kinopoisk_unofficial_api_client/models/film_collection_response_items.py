...
from ..models.film_collection_response_items_type import FilmCollectionResponseItemsType
...
T = TypeVar("T", bound="FilmCollectionResponseItems")


@_attrs_define
class FilmCollectionResponseItems:
    """
    Attributes:
        ...
        type (Union[Unset, FilmCollectionResponseItemsType]):  Example: FILM.
    ...
    type: Union[Unset, FilmCollectionResponseItemsType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        type: Union[Unset, FilmCollectionResponseItemsType]
        if isinstance(_type, Unset):
            type = UNSET
        else:
            type = FilmCollectionResponseItemsType(_type)

        poster_url = d.pop("posterUrl", UNSET)

        poster_url_preview = d.pop("posterUrlPreview", UNSET)

        film_collection_response_items = cls(
        ...
        film_collection_response_items.additional_properties = d
        return film_collection_response_items
