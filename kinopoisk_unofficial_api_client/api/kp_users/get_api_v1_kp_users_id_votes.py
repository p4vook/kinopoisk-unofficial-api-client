...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v1/kp_users/{id}/votes",
        "params": params,
    }
...
) -> Optional[Union[Any, KinopoiskUserVoteResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, KinopoiskUserVoteResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, KinopoiskUserVoteResponse]
    """
